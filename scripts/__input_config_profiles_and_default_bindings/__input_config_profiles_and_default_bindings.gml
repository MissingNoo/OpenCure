...
INPUT_DEFAULT_PROFILES = {
    ...
    keyboard_and_mouse:
    {
        up:    [input_binding_key(vk_up),    input_binding_key("1")],
        down:  [input_binding_key(vk_down),  input_binding_key("1")],
        left:  [input_binding_key(vk_left),  input_binding_key("1")],
        right: [input_binding_key(vk_right), input_binding_key("1")],
        
        accept:  input_binding_key("Z"),
        cancel:  input_binding_key(input_binding_key("X")),
